...
namespace BanTinIT.CMS.Controllers
{
    ...
    [Authorize]
    public class RoxyFilemanController : Controller // BaseAdminController
    {
        #region Fields
        ...
        public void DownloadDir(string path)
        {
            ...
            //TODO ZipFile.CreateFromDirectory(path, tmpZip, CompressionLevel.Fastest, true);
            _r.Clear();
